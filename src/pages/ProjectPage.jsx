...
function BackToProjectsLink() {
  return (
    <Link
      to="/#projects"
      className="inline-flex flex-shrink-0 items-center gap-1 rounded-full border border-navy-200 bg-navy-50 py-1 pl-1 pr-3 text-[11px] font-semibold text-navy-700 shadow-sm transition hover:border-navy-300 hover:bg-navy-100 dark:border-navy-700 dark:bg-navy-900 dark:text-navy-200 dark:hover:bg-navy-800"
    >
          ...
          <Reveal delay={0.05} className="mt-4">
            ...
            {project.repoUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-navy-800 px-3.5 py-1.5 text-xs font-semibold text-white transition hover:bg-navy-900 dark:bg-navy-700 dark:hover:bg-navy-600"
              >
