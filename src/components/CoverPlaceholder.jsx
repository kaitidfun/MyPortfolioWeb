...
export default function CoverPlaceholder({ label = "Cover image coming soon" }) {
  return (
    <div className="flex aspect-[16/9] w-full items-center justify-center rounded-xl border border-dashed border-navy-200 bg-navy-50 sm:aspect-[16/10] dark:border-navy-700 dark:bg-navy-800">
